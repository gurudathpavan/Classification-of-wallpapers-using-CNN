...
saveas(error_plot, ['LearningTransfer_Skinny_Error_plot_',num2str(numEpochs),'.png']);
...
filename = ['LearningTransfer_Training_Confusion_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
xlswrite(filename, con_mat_train,'Sheet1','A1');

filename = ['LearningTransfer_Training_Classification_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
...
filename = ['LearningTransfer_Validation_Confusion_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
xlswrite(filename, con_mat_val,'Sheet1','A1');

filename = ['LearningTransfer_Validation_Classification_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
...
filename = ['LearningTransfer_Testing_Confusion_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
xlswrite(filename, con_mat_test,'Sheet1','A1');

filename = ['LearningTransfer_Testing_Classification_Mat_Skinny_', num2str(numEpochs), '.xlsx'];
